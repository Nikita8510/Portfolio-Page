...
$header .= "From: Новая заявка <nikita.riabikin@mail.ru>\n\n";	
$mail = mail("nikita.riabikin@mail.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
